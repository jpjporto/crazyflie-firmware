...
## Enable magnetometer reading.
## Since we don't use it for anything, this can probably be disabled.
#CFLAGS += -DSENSORS_ENABLE_MAG_AK8963
## If we enable the mag, might as well use it in our estimator
#CFLAGS += -DKALMAN_USE_MAG_UPDATE
#CFLAGS += -DMAG_LEARNING

PLATFORM=CF2
ESTIMATOR=kalman
LPS_TDOA_ENABLE=1
CONTROLLER=hinfdecSparse_L1
POWER_DISTRIBUTION=hinf
CFLAGS += -DSETPOINT_VEL
#CFLAGS += -DNO_DECA
CFLAGS += -DDEC_DECA
#CFLAGS += -DCFNUM=1
